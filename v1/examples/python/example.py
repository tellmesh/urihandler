...
from urirun.v1 import compile_registry, run

bindings = json.loads((Path(__file__).resolve().parents[1] / "json" / "bindings.v1.example.json").read_text())
...
result = run("say://local/echo/msg", echo, payload={"text": "hello v1"},
