...
3. dispatch  - run the full cross-service flow with `urirun.v2_service`
...
def main() -> int:
    ...
    registry = v2.compile_registry({"bindings": bindings})
