...
- **Languages**: python: 101, json: 13, shell: 10, yaml: 4, csharp: 4
...
- `adapters.python.urirun.host.host_dashboard.create_handler` - 94 calls
...
- `adapters.python.urirun.host.host_dashboard.summary` - 32 calls
