...
*381 nodes · 500 edges · 31 modules · CC̄=4.2*
...
# generated in 0.18s
# nodes: 381 | edges: 500 | modules: 31
# CC̄=4.2
...
# code2llm | 134f 20497L | python:75,json:12,shell:10,yaml:4,csharp:4,txt:3,javascript:3,yml:2,java:2,go:2,typescript:2,perl:2,toml:2,rust:2,php:2,ruby:2,c:1,cpp:1 | 2026-06-22
# generated in 0.04s
# CC̅=4.2 | critical:13/958 | dups:0 | cycles:0
...
PIPELINES[327]:
  ...
  [38] Src [fail]: fail
      PURITY: 100% pure
  [39] Src [policy]: policy → build_policy
      PURITY: 100% pure
  [40] Src [action_space]: action_space
      PURITY: 100% pure
  [41] Src [result_data]: result_data
      PURITY: 100% pure
...
LAYERS:
  ...
  │ !! v2                        2497L  1C  125m  CC=14     ←3
  │ !! mesh                      2242L  3C  136m  CC=17     ←1
  │ !! _registry                  718L  0C   43m  CC=14     ←0
  │ !! _scan                      670L  0C   36m  CC=15     ←0
  │ !! __init__                   618L  1C   46m  CC=12     ←10
...
# code2llm/evolution | 945 func | 62f | 2026-06-22
# generated in 0.00s

NEXT[10] (ranked by impact):
  [1] !! SPLIT           adapters/python/urirun/node/mesh.py
      WHY: 2242L, 3 classes, max CC=17
      EFFORT: ~4h  IMPACT: 38114
